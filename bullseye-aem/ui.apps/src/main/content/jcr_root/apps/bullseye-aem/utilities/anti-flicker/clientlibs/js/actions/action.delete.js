(function(window, document, Granite, $) {
    ...
    const DELETE_CONFIGS_TITLE = Granite.I18n.get("Delete Configs");
    const DELETE_CONFIRMATION = Granite.I18n.get("Are you sure you would like to delete the selected anti-flicker configs and settings?");
    ...
    $(window).adaptTo("foundation-registry").register("foundation.collection.action.action", {
        name: "bullseye-aem.action.antiflicker.delete",
    ...
    function deleteConfigs(paths) {
        ...
        $.ajax({
            ...
            data: {
                "_charset_": "utf-8",
                "path": paths,
                "cmd": "deleteAntiFlickerConfigs"
            },
            success: function() {
                ui.notify(undefined, Granite.I18n.get("Anti-flicker configs deleted."));
                reload();
            },
            error: function(xhr) {
                ui.alert(
                    ERROR_TEXT,
                    Granite.I18n.get("Could not delete anti-flicker configs."),
                    'error');
            },
            complete: function() {
                ui.clearWait();
